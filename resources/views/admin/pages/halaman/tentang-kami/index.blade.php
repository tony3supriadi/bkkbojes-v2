...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div>
        ...
        <a href="{{ route('admin.tentang-kami.create') }}" class="btn btn-primary text-white">
        ...
        $('.datatable').DataTable({
            ...
            columns: [{
                ...
                render: (data, type, row, meta) => {
                    return `
                        @can('tentang-kami-update')
                        <a href="/app/v1/bkk-admin/tentang-kami/${row.encryptid}/ubah" class="mx-1 text-primary text-decoration-none">
                            <i class="fa fa-edit"></i> Ubah
                        </a>
                        @endcan

                        @can('tentang-kami-delete')
                        <a href="javascript:void(0)" onclick="action_destroy('/app/v1/bkk-admin/tentang-kami/${row.encryptid}')" class="mx-1 text-danger text-decoration-none btn-destroy">
