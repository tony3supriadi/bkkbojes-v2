...
<script type="text/javascript">
    $(document).ready(function() {
        $('.datatable').DataTable({
            ...
            processing: true,
            ajax: {
                url: "/app/v1/bkk-admin/pengguna/{{ encrypt($pengguna->id) }}/pendidikan?type=json",
                dataSrc: (data) => {
                    return data;
                }
            },
            ...
            columns: [{
                ...
                render: (data, type, row, meta) => {
                    return `${row.mulai_sekolah} s/d ${row.masih_sekolah ? 'Sekarang' : row.selesai_sekolah}`
                }
            }, {
                data: 'nama_sekolah',
                title: 'Sekolah / PTS / PTN'
            }, {
