...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div>
        ...
        <a href="{{ route('admin.testimonial.create') }}" class="btn btn-primary text-white">
        ...
        $('.datatable').DataTable({
            ...
            columns: [{
                ...
                render: (data, type, row, meta) => {
                    console.log(row)
                    return `${row.personal_nama} ${row.personal_nama_belakang}`
                }
            }, {
                data: 'jenis_akun',
                title: 'Jenis Akun',
                render: (data, type, row, meta) => {
                    return `${data} ${row.tahun_lulus ? '(' + row.tahun_lulus + ')' : ''}`
                }
            }, {
                data: 'bekerja_di',
                title: 'Bekerja di'
                ...
                render: (data, type, row, meta) => {
                    return `
                        ...
                        <a href="/app/v1/bkk-admin/testimonial/${row.encryptid}/ubah" class="mx-1 text-primary text-decoration-none">
                            <i class="fa fa-edit"></i> Ubah
                        </a>
                        @endcan

                        @can('testimonial-delete')
                        <a href="javascript:void(0)" onclick="action_destroy('/app/v1/bkk-admin/testimonial/${row.encryptid}')" class="mx-1 text-danger text-decoration-none btn-destroy">
