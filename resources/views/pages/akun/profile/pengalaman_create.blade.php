        ...
        <form action="{{ route('akun.profile.pengalaman.store') }}" method="post" class="row">
            ...
            <div class="col-md-4">
                <div class="form-group mb-3">
                    ...
                    <input type="date" name="mulai_bekerja" id="mulai_bekerja" data-date-format="DD MMM YYYY" placeholder="Tanggal mulai" value="{{ old('mulai_bekerja') }}" class="form-control @error('mulai_bekerja') is-invalid border-danger @enderror">
                    @error('mulai_bekerja')
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="selesai_bekerja" data-date-format="DD MMM YYYY" placeholder="Tanggal selesai" id="selesai_bekerja" value="{{ old('selesai_bekerja') }}" class="form-control @error('selesai_bekerja') is-invalid border-danger @enderror" @if(old('masih_bekerja')) readonly @endif>
            ...
            <div class="col-md-8">
                ...
                <div class="form-group mb-3">
                    ...
                    <select name="bidang_industri" data-placeholder="Pilih industri / bidang usaha" id="bidang_industri" class="form-control select2-basic @error('bidang_industri') is-invalid border-danger @enderror">
                        ...
                        <option value="{{ $ind }}" <?= old('bidang_industri') == $ind ? 'selected' : '' ?>>{{ $ind }}</option>
                        @endforeach

                        <option value="Lainnya" <?= (old('bidang_industri') && !in_array(old('bidang_industri'), $industries))
                                                    ? 'selected' : '' ?>>Lainnya</option>
                    </select>

                    <input type="text" name="bidang_industri" placeholder="Tuliskan bidang usaha lainnya" value="{{ old('bidang_industri') }}" class="form-control d-none mt-2 @error('bidang_industri') is-invalid border-danger @enderror" disabled>
