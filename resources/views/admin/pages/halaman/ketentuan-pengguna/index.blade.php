...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div>
        ...
        <a href="{{ route('admin.ketentuan-pengguna.create') }}" class="btn btn-primary text-white">
        ...
        $('.datatable').DataTable({
            ...
            columns: [{
                ...
                render: (data, type, row, meta) => {
                    return `
                        @can('ketentuan-pengguna-update')
                        <a href="/app/v1/bkk-admin/ketentuan-pengguna/${row.encryptid}/ubah" class="mx-1 text-primary text-decoration-none">
                            <i class="fa fa-edit"></i> Ubah
                        </a>
                        @endcan

                        @can('ketentuan-pengguna-delete')
                        <a href="javascript:void(0)" onclick="action_destroy('/app/v1/bkk-admin/ketentuan-pengguna/${row.encryptid}')" class="mx-1 text-danger text-decoration-none btn-destroy">
