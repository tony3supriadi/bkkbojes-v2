...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div>
        @can('users-update')
        <button type="button" class="btn btn-cancel btn-secondary d-none">
            <i class="la la-refresh"></i> Batal
        </button>
        <button type="button" class="btn btn-edit btn-secondary">
    ...
    <form action="{{ route('admin.users.update', encrypt($user->id)) }}" method="post">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" value="{{ old('name') ? old('name') : $user->name }}" class="form-control @error('name') is-invalid @enderror" disabled />
                @error('name')
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" id="email" value="{{ old('email') ? old('email') : $user->email }}" class="form-control @error('email') is-invalid @enderror" disabled />
                @error('email')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="form-group">
                ...
                <input type="text" name="username" id="username" value="{{ old('username') ? old('username') : $user->username }}" class="form-control @error('username') is-invalid @enderror" disabled />
                @error('username')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="form-group">
                ...
                <input type="password" name="password" id="password" class="form-control @error('password') is-invalid @enderror" disabled />
                @error('password')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="form-group">
                ...
                <input type="password" name="password_confirmation" id="password_confirmation" class="form-control @error('password_confirmation') is-invalid @enderror" disabled />
            </div>

            <div class="form-group">
                <label for="roles">Roles</label>
                <input type="text" value="{{ $userRole[0] }}" class="form-control select2-values" disabled>
