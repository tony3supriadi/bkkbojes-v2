...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div>
        ...
        @can('artikel-create')
        <a href="{{ route('admin.artikel.create') }}" class="btn btn-primary text-white">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('.datatable').DataTable({
            ...
            ajax: {
                url: '/app/v1/bkk-admin/artikel?type=json',
                dataSrc: (data) => {
                    return data;
                }
            },
            ...
            columns: [{
                ...
                render: (data, type, row, meta) => {
                    return `
                        @can('artikel-update')
                        <a href="/app/v1/bkk-admin/artikel/${row.encryptid}/ubah" class="mx-1 text-primary text-decoration-none">
                            <i class="fa fa-edit"></i>
                        </a>
                        @endcan

                        @can('artikel-delete')
                        <a href="javascript:void(0)" onclick="action_destroy('/app/v1/bkk-admin/artikel/${row.encryptid}')" class="mx-1 text-danger text-decoration-none btn-destroy">
